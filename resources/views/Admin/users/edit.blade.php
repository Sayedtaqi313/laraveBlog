                                ...
                                <div class="col-lg-10 col-md-10">
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            value="{{ old('name',$user->name) }}" placeholder="Enter User Name" name="name">
                                                @error('name')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            value="{{ old('email',$user->email) }}" placeholder="Enter User Email" name="email">
                                                @error('email')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="single-select" name="role_id"> 
                                                                @foreach ($roles as $key => $value)
                                                                    <option {{ $user->role_id === $value ? "selected" : "" }} value="{{ $value }}">
                                                                        {{ $key }}
                                                                    </option>
                                                                @endforeach
                                        ...
                                        <div class="mb-3 img-card">
                                            <div class="card" style="width:200px">
                                             <img src="{{ $user->image ?  asset('storage/'.$user->image->path) : asset('storage/images/placeholder/images.png') }}" class="img-responsive">
                                            </div>
                                         </div>
                                        <div class="mb-3">
